  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: "bot",
      content:
        "Hello! Welcome to JOEFLOXY GLOBAL VENTURES LTD. I'm here to help you with any questions about our services. How can I assist you today?",
      timestamp: new Date(),
    },
  ]);
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-purple-100">
                  Joefloxy Global Ventures Assistant
                </p>
              </div>
            </div>
            {/* <Button
